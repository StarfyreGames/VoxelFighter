...
namespace utils
{
    ...
    {
        public static ViewportPlane CreateBoundingViewportPlane(Camera targetCamera, GameObject gameObject,
            ViewportLock horizontalLock, int widthPercent, float widthInset, ViewportLock verticalLock,
            int heightPercent, float heightInset)
        {
